...
function getColorForNum(e) {
    return e <= 200 ? "#016730" : e > 200 && e <= 400 ? "#016730" : e > 400 && e <= 600 ? "#016730" : "#8CF096";
}

function getTextForNum(e) {
    return e <= 200 ? "Rất Nhanh" : e > 200 && e <= 400 ? "Nhanh" : e > 400 && e <= 600 ? "Chậm" : "Hồi Chậm";
}
...
function addFavorite() {
    ...
    if (n.indexOf("360se") > -1) alert("Do hiệu ứng chuyển động nặng của trình duyệt 360, vui lòng nhấn Ctrl+D để thu thập thủ công nhé!");
...
// 偵測是否為 ball51.com (包含帶 www 的情況)
if (window.location.hostname.indexOf("ball51.com") !== -1) {
    jsonLink.fill("https://ball8.ai/chs/home/index/in-play?code=10003");
}else if(window.location.hostname.indexOf("ball52.com") !== -1) {
    jsonLink.fill("https://ball8.ai/chs/home/index/in-play?code=10004");
}else if(window.location.hostname.indexOf("ball6.bet") !== -1) {
    jsonLink = [
    "https://ball6.vip",
    "https://ball6.vip",
    "https://ball6.me",
...
function randomizeUrls(data, linkList) {
    ...
    for (var i = 0; i < mainPositionList.length; i++) {
        ...
        //linkList.splice(randomIndex, 1); // Lo廕【 b廙� URL �齅� s廙� d廙叩g �𤒹� tr獺nh tr羅ng l廕搆
        mainPositionList[i].url = linkList[i];
    }
}
